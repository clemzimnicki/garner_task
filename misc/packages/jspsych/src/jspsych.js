/**
 * jspsych.js
 * Josh de Leeuw  - MAS edited version
 *
...
window.jsPsych = (function() {
  ...
  // end patch
  //core.webaudio_context = (typeof window !== 'undefined' && typeof window.AudioContext !== 'undefined') ? new AudioContext() : null; //uncomment me
  ...
  core.init = function(options) {
    ...
    var defaults = {
      ...
      'max_load_time': 120000, //Changed this from 60000
      'max_preload_attempts': 15, //Changed from 10 
      'default_iti': 0,
...
jsPsych.data = (function() {
  ...
  module.write = function(data_object) {
    ...
    var default_data = {
      ...
      'prim_subject':  progress.current_trial_global + '.' + randomID,
...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar) {
    ...
    if(progress_bar){
      var pb_html = '<span style="text-align: center; font-size: 100%;">'+"The experiment will load in a moment."+'</span>'; //added loading message
